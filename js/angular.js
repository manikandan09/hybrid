...
/****************************************************************************/	
	...
	$http.post('http://www.pythonprojects.org/ieee/hybrid/admin_details.php', {'email': $scope.bn_adm_email})
...
/****************************************************************************/
	...
	$http.get('http://www.pythonprojects.org/ieee/hybrid/total_get.php')
...
/****************************************************************************/
	$http.get('http://www.pythonprojects.org/ieee/hybrid/project_get.php')
	.success(function (response) 
	{
		if(response.success == 1)
		{
...
/****************************************************************************/
	...
	$http.get('http://www.pythonprojects.org/ieee/hybrid/sales_get.php')
	.success(function (response) 
	{
		if(response.success == 1)
		{
...
/****************************************************************************/
	...
	$http.get('http://www.pythonprojects.org/ieee/hybrid/task_get.php')
	.success(function (response) 
	{
		if(response.success == 1)
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://www.pythonprojects.org/ieee/hybrid/confirm_sales.php', 
		{
...
/****************************************************************************/
	...
	$http.post('http://www.pythonprojects.org/ieee/hybrid/products_get.php',{'status':$scope.status})
		.success(function (data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	...
	{
	$http.post('http://www.pythonprojects.org/ieee/hybrid/products_add.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://www.pythonprojects.org/ieee/hybrid/products_delete.php', 
		{
...
$scope.product_update_data = function() 
	{
	$http.post('http://www.pythonprojects.org/ieee/hybrid/products_update.php', {
...
/****************************************************************************/
	...
	{		
		$http.post('http://www.pythonprojects.org/ieee/hybrid/sales_create.php', 
...
/****************************************************************************/
	...
	{
	$http.post('http://www.pythonprojects.org/ieee/hybrid/sales_update.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://www.pythonprojects.org/ieee/hybrid/sales_delete.php', 
		{
		'customer_id': customer_id
		})
		.success(function(data, status, headers, config) 
